    ...
    return (
      ...
      >
        <H2 style={{ margin: 0, display: "flex", gap: "1rem" }} animatePulse>
         ...
         {github && <A href={github} amber300--hover transitionAll easeInOut duration-300>
            <GitHub />
          </A>
            }
        </H2>
        <Hr borderAmber300 border w="90%" left0 relative mb8 ml0 />
        {description}
    ...
    <>
      ...
      >
        ...
        <Box maxW-50rem>
          ...
          lately I am diving into the Rust programming language 🦀.
        </Box>
              ...
              <Box gray800 text3XL flex column white--dark>
                ...
                <Box
                    ...
                    onClick={() =>
                      setProjectSelected({
                        name: "NaVe Finance",
                        description: `Built a DeFi app successfully taking care of the frontend and backend part to interact with the Smart Contracts
                        built and deployed with Solidity on the BSC ecosystem. I built a functional and scalable REST API to feed on the
                        client’s requests, a structured system to keep track of each vault’s performance and liquidity.`,
                        tags: ["NextJS (React)", "Tailwind","NodeJS","MongoDB","Redis"],
                        href: "https://app.nave.finance",
                  ...
                  <Box
                    ...
                    onClick={() =>
                      setProjectSelected({
                        ...
                        github:
                          "https://github.com/aspnxdd/nft_floor_price_api/",
                      })
                    }
                  >
                  ...
                  <Box
                    ...
                    onClick={() =>
                      setProjectSelected({
                        name: "i18n Handler",
                        description: `This is a desktop app built with Electron and React (TS) which is a tool to handle a bunch of 
