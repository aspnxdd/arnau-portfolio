  ...
  return (
    <main>
      ...
      <p className="mt-10 text-xl text-gray-200 max-w-[60ch] leading-8">
        ...
        profficient at JavaScript/TypeScript ✔ and React ⚛️ and lately I am
        diving into the Rust programming language 🦀.
        <br />
        <br />I have over 3 years of experience in web development and I have
        worked with technologies such as Node.js, Express, MongoDB, PostgreSQL,
        React, Vue, Typescript, Next.js, TailwindCSS, GraphQL...
        <br />
